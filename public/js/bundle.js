...
},{"axios":"../../node_modules/axios/index.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
var reviewb = document.querySelector('.review');
var product = document.querySelector('.product');

var writeReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productId, review, rating) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/products/".concat(productId, "/reviews"),
              data: {
                review: review,
                rating: rating
              }
...
var stripe = Stripe('pk_test_51GqOZ0Gxi8h3WIFqOIoNNPPgXOmLCD941IYNfbBV01pqc5OX9Lvrb2bYf2Z0XHJWECJO6bWjzqZrPMDhyeeUnkvE00CJIzzE7X');

var purchaseProduct = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/products/checkout-session/".concat(productId));
  ...
  return function purchaseProduct(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var sendEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(bookDate, message) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
exports.updateMyPassword = exports.updateAccount = void 0;
...
var contactForm = document.querySelector('.form--email');
var accountForm = document.querySelector('.form--account');
var changePassForm = document.querySelector('.form--changePassword');
var productImgs = document.querySelector('.product__imgs');
var productHighlight = document.querySelector('.product__highlight');
var buyBtn = document.getElementById('buy-product'); //REVIEW

var writeReviewBtn = document.getElementById('writeReview');
var reviewForm = document.querySelector('.form--review');
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    (0, _review.writeReview)(productId, review, rating);
  });
...
if (contactForm) {
  contactForm.addEventListener('submit', function (e) {
    ...
    (0, _mail.sendEmail)(bookDate, message);
  });
}
...
if (productImgs) {
  productImgs.addEventListener('click', function (e) {
    e.preventDefault();
    var t = e.target; // Get src of the clicked img

    var clickedImg = t.src; // change the src of the highlight img to the src of clicked img
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // LOGIN FORM
...
if (buyBtn) {
  buyBtn.addEventListener('click', function (e) {
    ...
    (0, _stripe.purchaseProduct)(productId);
  });
} // ACCOUNT UPDATE
...
if (accountForm) {
  accountForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    (0, _updateSettings.updateAccount)(name, email);
  });
}
